...
export class UserService {
  ...
  public getVideos(search:string){
         return this.http.get(`https://www.googleapis.com/youtube/v3/search?part=snippet&key=XYZ-XYZ-XYZ
  ...
  //get covid info
  public getCovidInfo(){
    return this.http.get(`COVID-API`);
  }
  ...
  //count posts
  public countPosts(){
    return this.http.get(`${baseUrl}/user/count-posts`);
  }

  //count friends
  public countFriends(){
    return this.http.get(`${baseUrl}/user/count-friends`);
  }
